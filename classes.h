...
enum parameters {ELEMENT_LENGTH,const_t,const_k,const_lambda,const_v,const_y,const_a,const_d,const_n}; //Estas seran todas nuestras constantes para este ejercicio
...
class mesh{
        float parameters[9]; //la cantidad de nuestras constantes
        int sizes[3];
        node *node_list;
        element *element_list;
        condition *dirichlet_list;
    public:
        void setParameters(float l,float t,float k,float lambda,float v,float y,float a,float d,float n){ //seteo de cada uno de los parametros
            parameters[ELEMENT_LENGTH]=l;
            parameters[const_t]=t;
            parameters[const_k]=k;
            parameters[const_lambda]=lambda;
            parameters[const_v]=v;
            parameters[const_y]=y;
            parameters[const_a]=a;
            parameters[const_d]=d;
            parameters[const_n]=n;
        }
