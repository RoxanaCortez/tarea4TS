...
void leerMallayCondiciones(mesh &m){
    char filename[14];
    ifstream file;
    float l,t,k,lambda,v,y,a,d,n; //declaracion de nuetsras constantes del problema
    ...
    //leemos el archivo
    file >> l >> t >> k >> lambda >> v >> y >> a >> d >> n;
    file >> nnodes >> neltos >> ndirich_u >> ndirich_p;


    m.setParameters(l,t,k,lambda,v,y,a,d,n); //seteamos los valores que el archivo trae a la malla
